...
-------------------------------------------------------
前置配置方式：
UUID="" VMWSPORT="" VMWSDOMAIN="" VLWSPORT="" VLWSDOMAIN="" VLXHTTPPORT="" VLXHTTPDIRECTDOMAIN="" VLXHTTPDOMAIN="" ARGO_AUTH="" && bash <(curl -Ls https://raw.githubusercontent.com/crarm/pass-script/refs/heads/main/google-idx/install-xray.sh)
```
